            ...
            while True:
                ...
                for contour in contours:
                    if cv2.contourArea(contour) > min_contour_area:
                        ...
                        image_path = os.path.join(save_dir, "captured_image_{}.jpg".format_map(curr_time))
                        cv2.imwrite(image_path, frame)
                        print("Motion detected! Image saved to: {}".format(image_path))
                        prev_time = curr_time
...
if __name__ == "__main__":
    spc_detect()
>>>>>>> fec6694dedebd6b0a6be88ccd91dddc55b28bf70
